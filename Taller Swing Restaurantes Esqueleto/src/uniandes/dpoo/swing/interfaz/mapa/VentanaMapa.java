...
public class VentanaMapa extends JFrame implements ActionListener
{
    ...
    public VentanaMapa( VentanaPrincipal ventanaPrincipal, List<Restaurante> restaurantes )
    {
        ...
        panelMapa.actualizarMapa( restaurantes ); // Le pasamos la lista inicial de restaurantes
        ...
        radioTodos.setSelected( true ); // Dejamos "Todos" seleccionado por defecto al abrir la ventana
        
        radioVisitados = new JRadioButton( "Visitados" );
        radioVisitados.setActionCommand( VISITADOS );
        radioVisitados.addActionListener( this );
        
        // Agrupamos los botones para que solo uno pueda estar activo a la vez
        ButtonGroup grupoRadios = new ButtonGroup( );
        grupoRadios.add( radioTodos );
        grupoRadios.add( radioVisitados );
        
        // Añadimos los radios al panel auxiliar
        panelRadios.add( radioTodos );
        panelRadios.add( radioVisitados );
        
        // Añadimos el panel de los radios a la parte inferior (Sur) de la ventana
