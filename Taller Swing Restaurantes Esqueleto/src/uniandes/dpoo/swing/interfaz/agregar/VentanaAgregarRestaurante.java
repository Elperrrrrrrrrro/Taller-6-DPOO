...
public class VentanaAgregarRestaurante extends JFrame
{
    ...
    {
        // 1. Obtenemos los datos desde el panel de detalles
        ...
        // 2. Obtenemos las coordenadas desde el panel del mapa
        int[] coordenadas = panelMapa.getCoordenadas( );
        
        // 3. Enviamos toda la información a la ventana principal
