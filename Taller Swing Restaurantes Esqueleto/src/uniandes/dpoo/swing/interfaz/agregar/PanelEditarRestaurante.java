...
public class PanelEditarRestaurante extends JPanel
{
    ...
    {
        // Configuramos el layout: 3 filas, 2 columnas para organizar (Etiqueta -> Componente)
        ...
        // Agregar todos los elementos al panel (El orden importa para el GridLayout)
        add( lblNombre );
        add( txtNombre );
    ...
    {
        // Se obtiene el valor seleccionado en el JComboBox y se verifica si es "Sí"
