...
public class PanelDetallesRestaurante extends JPanel
{
    ...
    {
        // Configuramos un Layout de 3 filas para los componentes
        ...
        labCalificacion.setIcon( buscarIconoCalificacion( 1 ) ); // Icono inicial

        // Configura el checkbox para indicar si ya se visitó o no el restaurante
        chkVisitado = new JCheckBox( "Visitado" );
        chkVisitado.setEnabled( false ); // Lo ponemos en false porque es solo visual
